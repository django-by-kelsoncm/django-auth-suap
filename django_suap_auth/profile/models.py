...
class Perfil(models.Model):
    ...
    nome_usual = models.CharField(max_length=256, blank=True)
    nome_social = models.CharField(max_length=256, blank=True)
    nome_registro = models.CharField(max_length=256, blank=True)
    ...
    telefones_institucionais = models.JSONField(default=list, blank=True)
    curriculo_lattes = models.CharField(max_length=100, blank=True)

    # Atributos de Servidor
    setor_suap = models.CharField(max_length=100, blank=True)
    setor_siape = models.CharField(max_length=100, blank=True)
    jornada_trabalho = models.CharField(max_length=100, blank=True)
    categoria = models.CharField(max_length=100, blank=True)
    cargo = models.CharField(max_length=100, blank=True)
    disciplina_ingresso = models.CharField(max_length=100, blank=True)
    ...
    situacao_sistemica = models.CharField(max_length=100, blank=True)
    ...
    cota_sistec = models.CharField(max_length=100, blank=True)
    cota_mec = models.CharField(max_length=100, blank=True)
    linha_pesquisa = models.CharField(max_length=256, blank=True)
