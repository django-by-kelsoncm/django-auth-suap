...
class Perfil(models.Model):
    ...
    rg = models.CharField(max_length=256, null=True, blank=True)
    ...
    tipo_sanguineo = models.CharField(max_length=256, null=True, blank=True)
    sexo = models.CharField(max_length=256, null=True, blank=True)
    passaporte = models.CharField(max_length=256, null=True, blank=True)
    ...
    tipo_usuario = models.CharField(max_length=256, null=True, blank=True)
    tipo_vinculo = models.CharField(max_length=256, null=True, blank=True)
    telefones_institucionais = models.JSONField(default=list, null=True, blank=True)
    curriculo_lattes = models.CharField(max_length=256, null=True, blank=True)

    # Atributos de Servidor
    setor_suap = models.CharField(max_length=256, null=True, blank=True)
    setor_siape = models.CharField(max_length=256, null=True, blank=True)
    jornada_trabalho = models.CharField(max_length=256, null=True, blank=True)
    categoria = models.CharField(max_length=256, null=True, blank=True)
    cargo = models.CharField(max_length=256, null=True, blank=True)
    disciplina_ingresso = models.CharField(max_length=256, null=True, blank=True)

    # Atributos de Aluno
    ingresso = models.CharField(max_length=256, null=True, blank=True)
    periodo_referencia = models.IntegerField(null=True, blank=True)
    ira = models.CharField(max_length=256, null=True, blank=True)
    curso = models.CharField(max_length=256, null=True, blank=True)
    turno = models.CharField(max_length=256, null=True, blank=True)
    matriz = models.CharField(max_length=256, null=True, blank=True)
    qtd_periodos = models.IntegerField(null=True, blank=True)
    situacao = models.CharField(max_length=256, null=True, blank=True)
    situacao_sistemica = models.CharField(max_length=256, null=True, blank=True)
    data_migracao = models.CharField(max_length=256, null=True, blank=True)
    ...
    educasenso = models.CharField(max_length=256, null=True, blank=True)
    cota_sistec = models.CharField(max_length=256, null=True, blank=True)
    cota_mec = models.CharField(max_length=256, null=True, blank=True)
...
class Vinculo(models.Model):
    ...
    suap_id = models.IntegerField(null=True, blank=True)
    identificador = models.CharField(max_length=256, null=True, blank=True)
    tipo = models.CharField(max_length=256, null=True, blank=True)
    campus = models.CharField(max_length=256, null=True, blank=True)
    cargo = models.CharField(max_length=256, null=True, blank=True)
    categoria = models.CharField(max_length=256, null=True, blank=True)
