...
* **Personificação de Usuários (``django_suap_auth.impersonation``)**: Suporte a workflows de testes e suporte através da troca temporária de identidade de usuários.
